...
int main() {
    ...
    cout << g1<<endl<<endl; // Should print the matrix of the graph: [0, 1, 0], [1, 0, 1], [0, 1, 0]
    ...
    cout << g3<<endl<<endl;           // Should print the matrix of the graph: [0, 2, 1], [2, 0, 3], [1, 3, 0]

    g1 *= -2;        // Multiply the graph by -2.
    cout << g1<<endl<<endl; // Should print the matrix of the graph: [0, -2, 0], [-2, 0, -2], [0, -2, 0]

    g1 /= -2;
    ariel::Graph g4 = g1 * g2; // Multiply the two graphs together.
    cout<< g4<<endl<<endl;           // Should print the multiplication of the matrices of g1 and g2: [0, 0, 2], [1, 0, 1], [1, 0, 0]
    ...
    try {
        ...
        cout << e.what()
             << endl; // Should print "The number of columns in the first matrix must be equal to the number of rows in the second matrix."
    }
    ...
    cout<<g<<endl;                                    // Should print: "Graph with 3 vertices and 4 edges."
    ...
    cout<<g<<endl;                                    // Should print: "Graph with 5 vertices and 8 edges."
    ...
    cout<<g<<endl;                                     // Should print: "Graph with 5 vertices and 10 edges."
    cout << Algorithms::isConnected(g) << endl;        // Should print: "1" (true).
